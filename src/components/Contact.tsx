        ...
        >
            <div className='grid grid-cols-1 md:grid-cols-2 gap-16'>
                ...
                <div className='flex flex-col gap-8'>
                    <div className='space-y-4 group/title'>
                        ...
                        <p className='text-lg text-slate-300 font-light leading-relaxed max-w-sm'>
                            I'm always looking for conversations with people building at the frontier — whether it's AI, Data Science, or product ship.
                        </p>
                    </div>
                                    ...
                                    <div className='text-center space-y-4'>
                                        ...
                                        <div className='space-y-2'>
                                            ...
                                            <p className='text-slate-300 italic font-light'>
                                                "Thank you for reaching out! I appreciate your message and will get back to you as soon as possible. Looking forward to connecting!"
                                            </p>
                                        </div>
                                        <button
                ...
                <div className='grid grid-cols-1 gap-4 h-fit'>
                    {[
                        { label: 'EMAIL', value: 'nsbanidhar@gmail.com', href: 'mailto:nsbanidhar@gmail.com', icon: Mail },
                        { label: 'LINKEDIN', value: 'linkedin.com/in/g-banidhar-0a5046247/', href: 'https://linkedin.com/in/g-banidhar-0a5046247/', icon: Linkedin },
                        { label: 'GITHUB', value: 'github.com/NSBunny', href: 'https://github.com/NSBunny', icon: Github },
                        ...
                        >
                            <div className='flex items-center justify-between mb-2'>
                                <span className='text-[10px] font-bold tracking-[0.2em] text-cyan-400 uppercase'>{item.label}</span>
                                <item.icon className='h-4 w-4 text-slate-400 group-hover:text-cyan-400 transition-colors' />
                            </div>
                            <div className='text-lg font-medium text-slate-100 truncate'>{item.value}</div>
                        </a>
                    ))}
                </div>
            </div>
