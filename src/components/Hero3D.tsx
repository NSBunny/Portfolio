...
import { Points, PointMaterial, Float, useTexture, MeshDistortMaterial, Environment } from '@react-three/drei';
...
const BackgroundParticles = () => {
    ...
    useFrame((state) => {
        state.camera.position.z = 5 + Math.sin(state.clock.getElapsedTime() * 0.2) * 1;
    });
