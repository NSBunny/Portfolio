...
export const config: PortfolioConfig = {
    ...
    about: 'I’m an AI & ML engineering student passionate about building scalable, user-centric digital products that bridge design and technology.',
    ...
    certificates: [
        {
            ...
            date: 'Jul, 2024',
            description: 'Completed a 3-day workshop on basic programming organized by GNDEC University in collaboration with FOSSEE Project, IIT Bombay.',
            image: '/cert1.png',
        },
        {
            ...
            issuer: 'NxtWave',
            date: 'Sep, 2024',
            description: 'Acquired skills in Text-to-Image synthesis, Language Translation, and Chatbots using Deep Learning architectures.',
        ...
        },
        {
            ...
            issuer: 'Simplilearn',
            date: 'Oct, 2024',
            description: 'Developed proficiency in data preparation, modeling, and visualization with DAX and Power Query.',
            image: '/cert2.png',
        },
        {
            name: 'Java Boot Camp',
            issuer: 'LetsUpgrade',
            date: 'Jun, 2024',
            description: 'Hands-on experience with core Java concepts, OOP, and building basic applications.',
            image: '/cert3.png',
        },
        {
            ...
            issuer: 'Deloitte',
            date: 'Apr, 2025',
            description: 'Completed virtual job simulation on Forage, gaining experience in data analysis and forensic technology.',
            image: '/cert4.png',
        },
        {
            ...
            issuer: 'HP Life',
            date: 'Jul, 2025',
            description: 'Gained key data science methodologies and tools to make data-driven decisions.',
            image: '/cert5.png',
        },
    ],
};
